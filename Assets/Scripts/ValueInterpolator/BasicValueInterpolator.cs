namespace ValueInterpolator
{
    public abstract class BasicValueInterpolator
    {
        ...
        private InterpolationFunction.InterpolationFunction interpolator;
        ...
        public InterpolationFunction.InterpolationFunction Interpolator => interpolator;


        protected BasicValueInterpolator(float startValue, float endValue, InterpolationFunction.InterpolationFunction interpolator)
        {
        ...
        {
            return InterpolationFunction.InterpolationHelper.Lerp(StartValue, EndValue, interpolator.Transform(t));
        }

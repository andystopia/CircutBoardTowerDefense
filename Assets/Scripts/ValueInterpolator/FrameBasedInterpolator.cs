...
namespace ValueInterpolator
{
    ...
    public class FrameBasedInterpolator : BasicValueInterpolator
    {
        ...
        public FrameBasedInterpolator(float startValue, float endValue, int frames, InterpolationFunction.InterpolationFunction interpolationFunc) : base(startValue, endValue, interpolationFunc)
        {
            this.frames = frames;
            currentFrame = 0;
        }

...
public class FocusIndicator : MonoBehaviour, IFocusIndicator
{
    ...
    public void Awake()
    {
        ...
        leftEdge = new FocusEdge(transform.Find(LEFT_EDGE_NAME), edgeScale, new Vector3(-1, 0, 0),
            new Vector3(0, 1, 0));
        rightEdge = new FocusEdge(transform.Find(RIGHT_EDGE_NAME), edgeScale, new Vector3(1, 0, 0),
            new Vector3(0, 1, 0));
        bottomEdge = new FocusEdge(transform.Find(BOTTOM_EDGE_NAME), edgeScale, new Vector3(0, 0, -1),
            new Vector3(1, 0, 0));
    ...
    private void Update()
    {
        ...
        if (dimensionInterpolator != null)
        {
            ...
            var currentFrameDimensions = dimensionInterpolator.CurrentValue;
        ...
        if (colorInterpolator != null)
        {
            ...
            var updatedColor = colorInterpolator.CurrentValue;
    ...
    {
        if (ReferenceEquals(FocusedOn, focusable)) FocusedOn = null;
    }
    ...
    private void AnimateCenterAt(Vector3 center)
    {
        ...
        positionInterpolator = new PositionInterpolator(AnimationFrameDuration, transform.position, transformPosition,
            interpolatorFunction.GetInterpolationFunction(), transform);
    }
    ...
    public void AnimateBoundBox(Vector3 focusBoundExtents)
    {
        ...
        dimensionInterpolator = new VectorInterpolator.VectorInterpolator(startingDimensions, destinationDimensions,
    ...
    {
        var farEdgeWidth = height + edgeScale;
        var farEdgeHeight = width + edgeScale;

        var lengthHorizontal = farEdgeHeight * 2;
        var lengthVertical = farEdgeWidth * 2;
